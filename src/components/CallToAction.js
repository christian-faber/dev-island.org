  ...
  return (
    <div className="flex flex-col fixed w-32 shadow border m-4 right-2 bottom-4 z-10">
      <ul className="w-full mr-[3px] flex">
        <li className="m-[2px] h-10 w-1/3 bg-blue-300 text-black ">
          <a
        ...
        <li className="m-[2px] h-10 w-1/3  bg-slate-300 text-black">
          <a
        ...
        <li className="m-[2px] h-10 w-1/3 bg-purple-300 text-black">
          <a
      ...
      <ul className="flex flex-row w-full ">
        <Link
          to="/apply"
          className="w-full h-full m-[2px] bg-black flex justify-center align-middle items-center"
        >
